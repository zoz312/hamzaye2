...
class bodyit extends StatelessWidget {
  bodyit({super.key, required this.controller});
               ...
               child: Row (
                ...
                children: [
                      ...
                      Padding(
                        ...
                        child: Text(controller.data[index].price,style: TextStyle(color: Colors.white,fontSize: 20),),
                      ) 
                ],),
             );
            }),
